...
class HomeController extends Controller
{
    ...
    public function UserDashboard()
    {
        ...
        $balance = User::where('id', Auth::user()->id)->get();
    ...
    {
        return view('frontend.all_plans');
    }
    ...
    {
        return view('frontend.cryptocurrency');
    }
    ...
    public function Invest(Request $request)
    {
        ...
        if ($request->amount < $request->min) {
            ...
            if ($data > 0) {
                ...
                $capital = User::findorfail(Auth::user()->id);
                ...
                $capital->capital += $request->amount;
                $capital->balance += $request->amount;
