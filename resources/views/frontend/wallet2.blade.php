                            ...
                            <div class="col-12 grid-margin stretch-card" style="width: 100%;">
                                <div class="card card-change" style="width: 100%;">
                                    <div class="card-body" style="width: 100%;">
                                        ...
                                        <form class="forms-sample" action="{{route('confirm')}}" method="POST" enctype="multipart/form-data">
                                            @csrf

                                            <div class="form-group" style="display: none;">
                                                <label for="myInput">Send only {{$object->method}} to this address</label>
                                                <input type="text" readonly value="{{$object->id}}" name="id" class="form-control2" id="myInput" placeholder="Plan Name">
                                            </div>
