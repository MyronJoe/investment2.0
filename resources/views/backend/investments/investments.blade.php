    ...
    <div class="content-wrapper">
        <div class="row ">
            ...
            <div class="col-12 grid-margin">
                ...
                <!-- <a href="{{route('make_investment2')}}" class="badge badge-outline-success">Invest All</a> -->

                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Investments: ({{$invest_num}})</h4>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="badge badge-outline-warning">Done</a>
                                            @else
